...
namespace OpenGL
{
    ...
    partial class Gl
    {
        internal static partial class Delegates
        {
            ...
            internal delegate void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, ref Int32 length, ref Int32 size, ref OpenGL.ActiveAttribType type, String name); // Int32[] length, Int32[] size, out OpenGL.ActiveAttribType[] type, String name);
            internal static GetActiveAttrib glGetActiveAttrib;
            internal delegate void GetActiveSubroutineName(UInt32 program, OpenGL.ShaderType shadertype, UInt32 index, Int32 bufsize, ref Int32 length, String name); // Int32[] length, String name);
            ...
            internal delegate void GetActiveSubroutineUniformName(UInt32 program, OpenGL.ShaderType shadertype, UInt32 index, Int32 bufsize, ref Int32 length, String name); // Int32[] length, String name);
            internal static GetActiveSubroutineUniformName glGetActiveSubroutineUniformName;
            internal delegate void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, ref Int32 length, ref Int32 size, ref OpenGL.ActiveUniformType type, String name); // Int32[] length, Int32[] size, out OpenGL.ActiveUniformType[] type, String name);
            ...
            internal delegate void GetActiveUniformBlockName(UInt32 program, UInt32 uniformBlockIndex, Int32 bufSize, ref Int32 length, String uniformBlockName); // Int32[] length, String uniformBlockName);
            internal static GetActiveUniformBlockName glGetActiveUniformBlockName;
            internal delegate void GetActiveUniformName(UInt32 program, UInt32 uniformIndex, Int32 bufSize, ref Int32 length, String uniformName); // Int32[] length, String uniformName);
            ...
            internal delegate void GetObjectLabel(OpenGL.ObjectLabel identifier, UInt32 name, Int32 bufSize, ref Int32 length, String label); // Int32[] length, String label);
            internal static GetObjectLabel glGetObjectLabel;
            internal delegate void GetObjectPtrLabel(ref IntPtr ptr, Int32 bufSize, ref Int32 length, String label); // Int32[] length, String label);
            ...
            internal delegate void GetProgramInfoLog(UInt32 program, Int32 maxLength, ref Int32 length, String infoLog); // Int32[] length, String infoLog);
            ...
            internal delegate void GetProgramResourceName(UInt32 program, OpenGL.ProgramInterface programInterface, UInt32 index, Int32 bufSize, ref Int32 length, String name); // Int32[] length, String name);
            ...
            internal delegate void GetShaderSource(UInt32 shader, Int32 bufSize, ref Int32 length, String source); // Int32[] length, String source);
            ...
            internal delegate void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, ref Int32 length, ref Int32 size, ref OpenGL.ActiveAttribType type, String name); // Int32[] length, Int32[] size, out OpenGL.ActiveAttribType[] type, String name);
