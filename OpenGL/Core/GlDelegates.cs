...
namespace OpenGL
{
    ...
    partial class Gl
    {
        internal static partial class Delegates
        {
            ...
            internal delegate void GenBuffers(Int32 n, UInt32[] buffers);
            ...
            internal delegate void GenFramebuffers(Int32 n, UInt32[] ids);
            internal static GenFramebuffers glGenFramebuffers;
            internal delegate void GenProgramPipelines(Int32 n, UInt32[] pipelines);
            internal static GenProgramPipelines glGenProgramPipelines;
            internal delegate void GenQueries(Int32 n, UInt32[] ids);
            internal static GenQueries glGenQueries;
            internal delegate void GenRenderbuffers(Int32 n, UInt32[] renderbuffers);
            internal static GenRenderbuffers glGenRenderbuffers;
            internal delegate void GenSamplers(Int32 n, UInt32[] samplers);
            internal static GenSamplers glGenSamplers;
            internal delegate void GenTextures(Int32 n, UInt32[] textures);
            internal static GenTextures glGenTextures;
            internal delegate void GenTransformFeedbacks(Int32 n, UInt32[] ids);
            internal static GenTransformFeedbacks glGenTransformFeedbacks;
            internal delegate void GenVertexArrays(Int32 n, UInt32[] arrays);
            ...
            internal delegate void GetDoublev(OpenGL.GetPName pname, ref Double data); // Double[] data);
            internal static GetDoublev glGetDoublev;
            internal delegate void GetFloatv(OpenGL.GetPName pname, ref Single data); // Single[] data);
            internal static GetFloatv glGetFloatv;
            internal delegate void GetIntegerv(OpenGL.GetPName pname, ref Int32 data); // Int32[] data);
            internal static GetIntegerv glGetIntegerv;
            internal delegate void GetInteger64v(OpenGL.ArbSync pname, ref Int64 data); // Int64[] data);
            ...
            internal delegate void GetIntegeri_v(OpenGL.GetPName target, UInt32 index, ref Int32 data); // Int32[] data);
            internal static GetIntegeri_v glGetIntegeri_v;
            internal delegate void GetFloati_v(OpenGL.GetPName target, UInt32 index, ref Single data); // Single[] data);
            internal static GetFloati_v glGetFloati_v;
            internal delegate void GetDoublei_v(OpenGL.GetPName target, UInt32 index, ref Double data); // Double[] data);
            internal static GetDoublei_v glGetDoublei_v;
            internal delegate void GetInteger64i_v(OpenGL.GetPName target, UInt32 index, ref Int64 data); // Int64[] data);
            internal static GetInteger64i_v glGetInteger64i_v;
            internal delegate void GetActiveAtomicCounterBufferiv(UInt32 program, UInt32 bufferIndex, OpenGL.AtomicCounterParameterName pname, ref Int32 @params); // Int32[] @params);
            internal static GetActiveAtomicCounterBufferiv glGetActiveAtomicCounterBufferiv;
            internal delegate void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, ref Int32 length, ref Int32 size, ref OpenGL.ActiveAttribType type, byte[] name); // Int32[] length, Int32[] size, out OpenGL.ActiveAttribType[] type, String name);
            internal static GetActiveAttrib glGetActiveAttrib;
            internal delegate void GetActiveSubroutineName(UInt32 program, OpenGL.ShaderType shadertype, UInt32 index, Int32 bufsize, ref Int32 length, byte[] name); // Int32[] length, String name);
            internal static GetActiveSubroutineName glGetActiveSubroutineName;
            internal delegate void GetActiveSubroutineUniformiv(UInt32 program, OpenGL.ShaderType shadertype, UInt32 index, OpenGL.SubroutineParameterName pname, ref Int32 values); // Int32[] values);
            internal static GetActiveSubroutineUniformiv glGetActiveSubroutineUniformiv;
            internal delegate void GetActiveSubroutineUniformName(UInt32 program, OpenGL.ShaderType shadertype, UInt32 index, Int32 bufsize, ref Int32 length, byte[] name); // Int32[] length, String name);
            internal static GetActiveSubroutineUniformName glGetActiveSubroutineUniformName;
            internal delegate void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, ref Int32 length, ref Int32 size, ref OpenGL.ActiveUniformType type, byte[] name); // Int32[] length, Int32[] size, out OpenGL.ActiveUniformType[] type, String name);
            internal static GetActiveUniform glGetActiveUniform;
            internal delegate void GetActiveUniformBlockiv(UInt32 program, UInt32 uniformBlockIndex, OpenGL.ActiveUniformBlockParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetActiveUniformBlockiv glGetActiveUniformBlockiv;
            internal delegate void GetActiveUniformBlockName(UInt32 program, UInt32 uniformBlockIndex, Int32 bufSize, ref Int32 length, byte[] uniformBlockName); // Int32[] length, String uniformBlockName);
            internal static GetActiveUniformBlockName glGetActiveUniformBlockName;
            internal delegate void GetActiveUniformName(UInt32 program, UInt32 uniformIndex, Int32 bufSize, ref Int32 length, byte[] uniformName); // Int32[] length, String uniformName);
            internal static GetActiveUniformName glGetActiveUniformName;
            internal delegate void GetActiveUniformsiv(UInt32 program, Int32 uniformCount, UInt32[] uniformIndices, OpenGL.ActiveUniformType pname, Int32[] @params);
            internal static GetActiveUniformsiv glGetActiveUniformsiv;
            internal delegate void GetAttachedShaders(UInt32 program, Int32 maxCount, ref Int32 count, UInt32[] shaders); // Int32[] count, UInt32[] shaders);
            ...
            internal delegate void GetBufferParameteriv(OpenGL.BufferTarget target, OpenGL.BufferParameterName value, out Int32 data); // Int32[] data);
            internal static GetBufferParameteriv glGetBufferParameteriv;
            internal delegate void GetBufferParameteri64v(OpenGL.BufferTarget target, OpenGL.BufferParameterName value, out Int64 data); // Int64[] data);
            internal static GetBufferParameteri64v glGetBufferParameteri64v;
            internal delegate void GetNamedBufferParameteriv(UInt32 buffer, OpenGL.BufferParameterName pname, out Int32 @params); // Int32[] @params);
            internal static GetNamedBufferParameteriv glGetNamedBufferParameteriv;
            internal delegate void GetNamedBufferParameteri64v(UInt32 buffer, OpenGL.BufferParameterName pname, out Int64 @params); // Int64[] @params);
            ...
            internal delegate void GetFramebufferAttachmentParameteriv(OpenGL.FramebufferTarget target, OpenGL.FramebufferAttachment attachment, OpenGL.FramebufferParameterName pname, out Int32 @params); // Int32[] @params);
            internal static GetFramebufferAttachmentParameteriv glGetFramebufferAttachmentParameteriv;
            internal delegate void GetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, OpenGL.FramebufferAttachment attachment, OpenGL.FramebufferParameterName pname, out Int32 @params); // Int32[] @params);
            internal static GetNamedFramebufferAttachmentParameteriv glGetNamedFramebufferAttachmentParameteriv;
            internal delegate void GetFramebufferParameteriv(OpenGL.FramebufferTarget target, OpenGL.FramebufferPName pname, out Int32 @params); // Int32[] @params);
            internal static GetFramebufferParameteriv glGetFramebufferParameteriv;
            internal delegate void GetNamedFramebufferParameteriv(UInt32 framebuffer, OpenGL.FramebufferPName pname, out Int32 param); // Int32[] param);
            ...
            internal delegate void GetInternalformativ(OpenGL.TextureTarget target, OpenGL.PixelInternalFormat internalFormat, OpenGL.GetPName pname, Int32 bufSize, Int32[] @params);
            internal static GetInternalformativ glGetInternalformativ;
            internal delegate void GetInternalformati64v(OpenGL.TextureTarget target, OpenGL.PixelInternalFormat internalFormat, OpenGL.GetPName pname, Int32 bufSize, Int64[] @params);
            internal static GetInternalformati64v glGetInternalformati64v;
            internal delegate void GetMultisamplefv(OpenGL.GetMultisamplePName pname, UInt32 index, Single[] val);
            internal static GetMultisamplefv glGetMultisamplefv;
            internal delegate void GetObjectLabel(OpenGL.ObjectLabel identifier, UInt32 name, Int32 bufSize, ref Int32 length, byte[] label); // Int32[] length, String label);
            internal static GetObjectLabel glGetObjectLabel;
            internal delegate void GetObjectPtrLabel(ref IntPtr ptr, Int32 bufSize, ref Int32 length, byte[] label); // Int32[] length, String label);
            internal static GetObjectPtrLabel glGetObjectPtrLabel;
            internal delegate void GetPointerv(OpenGL.GetPointerParameter pname, out nint @params);
            internal static GetPointerv glGetPointerv;
            internal delegate void GetProgramiv(UInt32 program, OpenGL.ProgramParameter pname, out Int32 @params);
            internal static GetProgramiv glGetProgramiv;
            internal delegate void GetProgramBinary(UInt32 program, Int32 bufsize, ref Int32 length, ref Int32 binaryFormat, nint binary); // Int32[] length, Int32[] binaryFormat, out IntPtr binary);
            internal static GetProgramBinary glGetProgramBinary;
            internal delegate void GetProgramInfoLog (UInt32 program, Int32 maxLength, ref Int32 length, byte[] infoLog); // Int32[] length, String infoLog);
            internal static GetProgramInfoLog glGetProgramInfoLog;
            internal delegate void GetProgramInterfaceiv(UInt32 program, OpenGL.ProgramInterface programInterface, OpenGL.ProgramInterfaceParameterName pname, out Int32 @params); // Int32[] @params);
            internal static GetProgramInterfaceiv glGetProgramInterfaceiv;
            internal delegate void GetProgramPipelineiv(UInt32 pipeline, Int32 pname, ref Int32 @params); // Int32[] @params);
            internal static GetProgramPipelineiv glGetProgramPipelineiv;
            internal delegate void GetProgramPipelineInfoLog(UInt32 pipeline, Int32 bufSize, ref Int32 length, byte[] infoLog); // Int32[] length, String infoLog);
            ...
            internal delegate void GetProgramResourceName(UInt32 program, OpenGL.ProgramInterface programInterface, UInt32 index, Int32 bufSize, ref Int32 length, byte[] name); // Int32[] length, String name);
            internal static GetProgramResourceName glGetProgramResourceName;
            internal delegate void GetProgramStageiv(UInt32 program, OpenGL.ShaderType shadertype, OpenGL.ProgramStageParameterName pname, out Int32 values); // Int32[] values);
            internal static GetProgramStageiv glGetProgramStageiv;
            internal delegate void GetQueryIndexediv(OpenGL.QueryTarget target, UInt32 index, OpenGL.GetQueryParam pname, out Int32 @params); // Int32[] @params);
            internal static GetQueryIndexediv glGetQueryIndexediv;
            internal delegate void GetQueryiv(OpenGL.QueryTarget target, OpenGL.GetQueryParam pname, ref Int32 @params); // Int32[] @params);
            internal static GetQueryiv glGetQueryiv;
            internal delegate void GetQueryObjectiv(UInt32 id, OpenGL.GetQueryObjectParam pname, ref Int32 @params); // Int32[] @params);
            internal static GetQueryObjectiv glGetQueryObjectiv;
            internal delegate void GetQueryObjectuiv(UInt32 id, OpenGL.GetQueryObjectParam pname, ref UInt32 @params); // UInt32[] @params);
            internal static GetQueryObjectuiv glGetQueryObjectuiv;
            internal delegate void GetQueryObjecti64v(UInt32 id, OpenGL.GetQueryObjectParam pname, ref Int64 @params); // Int64[] @params);
            internal static GetQueryObjecti64v glGetQueryObjecti64v;
            internal delegate void GetQueryObjectui64v(UInt32 id, OpenGL.GetQueryObjectParam pname, ref UInt64 @params); // UInt64[] @params);
            internal static GetQueryObjectui64v glGetQueryObjectui64v;
            internal delegate void GetRenderbufferParameteriv(OpenGL.RenderbufferTarget target, OpenGL.RenderbufferParameterName pname, ref Int32 @params); // Int32[] @params);
            internal static GetRenderbufferParameteriv glGetRenderbufferParameteriv;
            internal delegate void GetNamedRenderbufferParameteriv(UInt32 renderbuffer, OpenGL.RenderbufferParameterName pname, ref Int32 @params); // Int32[] @params);
            internal static GetNamedRenderbufferParameteriv glGetNamedRenderbufferParameteriv;
            internal delegate void GetSamplerParameterfv(UInt32 sampler, OpenGL.TextureParameterName pname, ref Single @params); // Single[] @params);
            internal static GetSamplerParameterfv glGetSamplerParameterfv;
            internal delegate void GetSamplerParameteriv(UInt32 sampler, OpenGL.TextureParameterName pname, ref Int32 @params); // Int32[] @params);
            internal static GetSamplerParameteriv glGetSamplerParameteriv;
            internal delegate void GetSamplerParameterIiv(UInt32 sampler, OpenGL.TextureParameterName pname, ref Int32 @params); // Int32[] @params);
            ...
            internal delegate void GetShaderInfoLog(UInt32 shader, Int32 maxLength, ref Int32 length, byte[] infoLog); // Int32[] length, String infoLog);
            internal static GetShaderInfoLog glGetShaderInfoLog;
            internal delegate void GetShaderPrecisionFormat(OpenGL.ShaderType shaderType, Int32 precisionType, Int32[] range, out Int32 precision);
            internal static GetShaderPrecisionFormat glGetShaderPrecisionFormat;
            internal delegate void GetShaderSource(UInt32 shader, Int32 bufSize, ref Int32 length, byte[] source); // Int32[] length, String source);
            ...
            internal delegate void GetSynciv(IntPtr sync, OpenGL.ArbSync pname, Int32 bufSize, ref Int32 length, Int32[] values); // Int32[] length, Int32[] values);
            ...
            internal delegate void GetTexLevelParameterfv(OpenGL.GetPName target, Int32 level, OpenGL.GetTextureLevelParameter pname, ref Single @params); // Single[] @params);
            internal static GetTexLevelParameterfv glGetTexLevelParameterfv;
            internal delegate void GetTexLevelParameteriv(OpenGL.GetPName target, Int32 level, OpenGL.GetTextureLevelParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetTexLevelParameteriv glGetTexLevelParameteriv;
            internal delegate void GetTextureLevelParameterfv(UInt32 texture, Int32 level, OpenGL.GetTextureLevelParameter pname, ref Single @params); // Single[] @params);
            internal static GetTextureLevelParameterfv glGetTextureLevelParameterfv;
            internal delegate void GetTextureLevelParameteriv(UInt32 texture, Int32 level, OpenGL.GetTextureLevelParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetTextureLevelParameteriv glGetTextureLevelParameteriv;
            internal delegate void GetTexParameterfv(OpenGL.TextureTarget target, OpenGL.GetTextureParameter pname, ref Single @params); // Single[] @params);
            internal static GetTexParameterfv glGetTexParameterfv;
            internal delegate void GetTexParameteriv(OpenGL.TextureTarget target, OpenGL.GetTextureParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetTexParameteriv glGetTexParameteriv;
            internal delegate void GetTexParameterIiv(OpenGL.TextureTarget target, OpenGL.GetTextureParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetTexParameterIiv glGetTexParameterIiv;
            internal delegate void GetTexParameterIuiv(OpenGL.TextureTarget target, OpenGL.GetTextureParameter pname, ref UInt32 @params); // UInt32[] @params);
            internal static GetTexParameterIuiv glGetTexParameterIuiv;
            internal delegate void GetTextureParameterfv(UInt32 texture, OpenGL.GetTextureParameter pname, ref Single @params); // Single[] @params);
            internal static GetTextureParameterfv glGetTextureParameterfv;
            internal delegate void GetTextureParameteriv(UInt32 texture, OpenGL.GetTextureParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetTextureParameteriv glGetTextureParameteriv;
            internal delegate void GetTextureParameterIiv(UInt32 texture, OpenGL.GetTextureParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetTextureParameterIiv glGetTextureParameterIiv;
            internal delegate void GetTextureParameterIuiv(UInt32 texture, OpenGL.GetTextureParameter pname, ref UInt32 @params); // UInt32[] @params);
            ...
            internal delegate void GetTransformFeedbackiv(UInt32 xfb, OpenGL.TransformFeedbackParameterName pname, ref Int32 param); // Int32[] param);
            internal static GetTransformFeedbackiv glGetTransformFeedbackiv;
            internal delegate void GetTransformFeedbacki_v(UInt32 xfb, OpenGL.TransformFeedbackParameterName pname, UInt32 index, ref Int32 param); // Int32[] param);
            internal static GetTransformFeedbacki_v glGetTransformFeedbacki_v;
            internal delegate void GetTransformFeedbacki64_v(UInt32 xfb, OpenGL.TransformFeedbackParameterName pname, UInt32 index, ref Int64 param); // Int64[] param);
            internal static GetTransformFeedbacki64_v glGetTransformFeedbacki64_v;
            internal delegate void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, ref Int32 length, ref Int32 size, ref OpenGL.ActiveAttribType type, byte[] name); // Int32[] length, Int32[] size, out OpenGL.ActiveAttribType[] type, String name);
            internal static GetTransformFeedbackVarying glGetTransformFeedbackVarying;
            internal delegate void GetUniformfv(UInt32 program, Int32 location, ref Single @params); // Single[] @params);
            internal static GetUniformfv glGetUniformfv;
            internal delegate void GetUniformiv(UInt32 program, Int32 location, ref Int32 @params); // Int32[] @params);
            internal static GetUniformiv glGetUniformiv;
            internal delegate void GetUniformuiv(UInt32 program, Int32 location, ref UInt32 @params); // UInt32[] @params);
            internal static GetUniformuiv glGetUniformuiv;
            internal delegate void GetUniformdv(UInt32 program, Int32 location, ref Double @params); // Double[] @params);
            internal static GetUniformdv glGetUniformdv;
            internal delegate void GetnUniformfv(UInt32 program, Int32 location, Int32 bufSize, Single[] @params);
            internal static GetnUniformfv glGetnUniformfv;
            internal delegate void GetnUniformiv(UInt32 program, Int32 location, Int32 bufSize, Int32[] @params);
            internal static GetnUniformiv glGetnUniformiv;
            internal delegate void GetnUniformuiv(UInt32 program, Int32 location, Int32 bufSize, UInt32[] @params);
            internal static GetnUniformuiv glGetnUniformuiv;
            internal delegate void GetnUniformdv(UInt32 program, Int32 location, Int32 bufSize, Double[] @params);
            ...
            internal delegate void GetUniformIndices(UInt32 program, Int32 uniformCount, String[] uniformNames, UInt32[] uniformIndices);
            ...
            internal delegate void GetUniformSubroutineuiv(OpenGL.ShaderType shadertype, Int32 location, ref UInt32 values); // UInt32[] values);
            internal static GetUniformSubroutineuiv glGetUniformSubroutineuiv;
            internal delegate void GetVertexArrayIndexed64iv(UInt32 vaobj, UInt32 index, OpenGL.VertexAttribParameter pname, ref Int64 param); // Int64[] param);
            internal static GetVertexArrayIndexed64iv glGetVertexArrayIndexed64iv;
            internal delegate void GetVertexArrayIndexediv(UInt32 vaobj, UInt32 index, OpenGL.VertexAttribParameter pname, ref Int32 param); // Int32[] param);
            internal static GetVertexArrayIndexediv glGetVertexArrayIndexediv;
            internal delegate void GetVertexArrayiv(UInt32 vaobj, OpenGL.VertexAttribParameter pname, ref Int32 param); // Int32[] param);
            internal static GetVertexArrayiv glGetVertexArrayiv;
            internal delegate void GetVertexAttribdv(UInt32 index, OpenGL.VertexAttribParameter pname, ref Double @params); // Double[] @params);
            internal static GetVertexAttribdv glGetVertexAttribdv;
            internal delegate void GetVertexAttribfv(UInt32 index, OpenGL.VertexAttribParameter pname, ref Single @params); // Single[] @params);
            internal static GetVertexAttribfv glGetVertexAttribfv;
            internal delegate void GetVertexAttribiv(UInt32 index, OpenGL.VertexAttribParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetVertexAttribiv glGetVertexAttribiv;
            internal delegate void GetVertexAttribIiv(UInt32 index, OpenGL.VertexAttribParameter pname, ref Int32 @params); // Int32[] @params);
            internal static GetVertexAttribIiv glGetVertexAttribIiv;
            internal delegate void GetVertexAttribIuiv(UInt32 index, OpenGL.VertexAttribParameter pname, ref UInt32 @params); // UInt32[] @params);
            internal static GetVertexAttribIuiv glGetVertexAttribIuiv;
            internal delegate void GetVertexAttribLdv(UInt32 index, OpenGL.VertexAttribParameter pname, ref Double @params); // Double[] @params);
